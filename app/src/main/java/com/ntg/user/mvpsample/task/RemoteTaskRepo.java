...
public class RemoteTaskRepo implements TasksDataSource {
    ...
    private RemoteTaskRepo(RetrofitProvider retrofitProvider) {
        this.retrofitProvider = retrofitProvider;
    }

    public static RemoteTaskRepo getInstance(RetrofitProvider retrofitProvider) {
        if (instance == null)
            instance = new RemoteTaskRepo(retrofitProvider);
        return instance;
    }
