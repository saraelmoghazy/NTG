...
public class TasksRepository  implements TasksDataSource{
   ...
   @Override
    public void saveTask(@NonNull Task task) {
        ...
        mCachedTasks.put(task.getUserId(), task);
    }
    ...
    public void completeTask(@NonNull Task task) {
        ...
        mCachedTasks.put(task.getUserId(), completedTask);
    }
   ...
   @Override
    public void activateTask(@NonNull Task task) {
        ...
        mCachedTasks.put(task.getUserId(), activeTask);
    }
   ...
   @Override
    public void getTask(@NonNull final String taskId, @NonNull final TasksDataSource.GetTaskCallback callback) {
        ...
        mTasksLocalDataSource.getTask(taskId, new TasksDataSource.GetTaskCallback() {
            ...
            @Override
            public void onDataNotAvailable() {
                mTasksRemoteDataSource.getTask(taskId, new TasksDataSource.GetTaskCallback() {
                    @Override
                    public void onTaskLoaded(Task task) {
                        // Do in memory cache update to keep the app UI up to date
                        if (mCachedTasks == null) {
